...
export default function RegisterPage() {
  ...
  const validate = (): boolean => {
    ...
    if (formData.linkedinUrl && !linkedinRegex.test(formData.linkedinUrl))
      tempErrors.linkedinUrl = "Invalid LinkedIn URL format.";
    ...
    <div className="bg-[#F9F8F5] h-screen">
      <div className="max-w-[1440px] mx-auto flex justify-between">
        <div className="lg:w-[50%] mx-auto">
          ...
          <form className="w-[360px] mx-auto mt-[58px] max-sm:px-2">
            ...
            <p className="text-[#475467] leading-[24px] mb-[32px] max-lg:text-center">
              Create your account and start improving your interview skills.
            </p>

            <div className="mb-[32px]">
              <div className="flex flex-col gap-y-[3px] mb-[10px]">
              ...
              <div className="flex flex-col gap-y-[6px] mb-[9px]">
                <label htmlFor="linkedinUrl">Your LinkedIn</label>
                <input
                  name="linkedinUrl"
                ...
                />
                {errors.linkedinUrl && (
                  <span className="text-red-500">{errors.linkedinUrl}</span>
                )}
              </div>
            ...
            <div className="w-full text-center">
              <span className="text-[#475467] text-[14px] ">
                ...
                <Link href={"/login"} className="text-[#05A105]">
                  Log in
                </Link>
              </span>
            </div>
          ...
          <div className="flex justify-between px-[32px] mt-[102px]">
